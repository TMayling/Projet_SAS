...
/* Création des librairies */
LIBNAME XL_2017 XLSX '/home/u62479205/TD6/Hospi_2017.xlsx';
LIBNAME XL_2018 XLSX '/home/u62479205/TD6/Hospi_2018.xlsx';
LIBNAME XL_2019 XLSX '/home/u62479205/TD6/Hospi_2019.xlsx';
...
Lit_par_acc = CI_AC8/CI_A11;
Temps_plein_par_acc = CI_RH5/CI_A11;
RUN;

/*
PROC SQL;
SELECT count(finess) as nb
